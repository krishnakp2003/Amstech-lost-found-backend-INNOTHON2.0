package com.lost.found.restresponse;
...
import com.lost.found.util.DateHelper;
...
public class RestResponse implements Map<String, Object> {
	...
	public static RestResponse build() {
		return new RestResponse().withCurrentTimestamp(DateHelper.getCurrentDate().getTime());
	}
